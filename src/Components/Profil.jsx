...
const Profil = () => {
  return (
    <div className='bg-black text-white text-center py-20'>
      ...
      <button className='bg-gradient-to-r from-green-400 to-blue-500 text-white hidden md:inline transform transition-transform duration-0 hover:scale-105 px-4 py-2 rounded-full'>Message</button>
    </div>
  )
}
